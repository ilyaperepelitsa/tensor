...
conv2_1 = conv_layer(conv1, shape = [3, 3, C1, C2])
conv2_2 = conv_layer(conv1_1, shape = [3, 3, C2, C2])
conv2_3 = conv_layer(conv1_2, shape = [3, 3, C2, C2])
conv2_pool = max_pool_2x2(conv1_3)
conv2_drop = tf.nn.dropout(conv1_pool, keep_prob = keep_prob)
